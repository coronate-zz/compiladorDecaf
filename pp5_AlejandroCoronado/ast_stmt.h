...
class Program : public Node
{
  ...
  public:
    ...
    const char *nombreNodo() { return "Program"; }
...
class StmtBlock : public Stmt
{
  ...
  public:
    ...
    const char *nombreNodo() { return "StmtBlock"; }
    void impresionAux(int indentLevel);
...
class ForStmt : public LoopStmt
{
  ...
  public:
    ...
    const char *nombreNodo() { return "ForStmt"; }
    void impresionAux(int indentLevel);
...
class WhileStmt : public LoopStmt
{
  public:
    ...
    const char *nombreNodo() { return "WhileStmt"; }
    void impresionAux(int indentLevel);
...
class IfStmt : public ConditionalStmt
{
  ...
  public:
    ...
    const char *nombreNodo() { return "IfStmt"; }
    void impresionAux(int indentLevel);
...
class BreakStmt : public Stmt
{
  public:
    ...
    const char *nombreNodo() { return "BreakStmt"; }
...
class CaseStmt : public Stmt
{
  ...
  public:
    ...
    const char *nombreNodo() { return value ? "Case" : "Default"; }
    void impresionAux(int indentLevel);
...
class SwitchStmt : public Stmt
{
  ...
  public:
    ...
    const char *nombreNodo() { return "SwitchStmt"; }
    void impresionAux(int indentLevel);
...
class ReturnStmt : public Stmt
{
  ...
  public:
    ...
    const char *nombreNodo() { return "ReturnStmt"; }
    void impresionAux(int indentLevel);
...
class PrintStmt : public Stmt
{
  ...
  public:
    ...
    const char *nombreNodo() { return "PrintStmt"; }
    void impresionAux(int indentLevel);
