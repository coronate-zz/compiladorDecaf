...
class Decl : public Node
{
  ...
  public:
    ...
    virtual void agregandoMetodosPX() {}
};
...
class VarDecl : public Decl
{
  ...
  public:
    ...
    const char *nombreNodo() { return "VarDecl"; }
...
class ClassDecl : public Decl
{
  ...
  public:
    ...
    const char *nombreNodo() { return "ClassDecl"; }
    void impresionAux(int indentLevel);
...
class InterfaceDecl : public Decl
{
  ...
  public:
    ...
    const char *nombreNodo() { return "InterfaceDecl"; }
    void impresionAux(int indentLevel);
...
class FnDecl : public Decl
{
  ...
  public:
    ...
    const char *nombreNodo() { return "FnDecl"; }
    void impresionAux(int indentLevel);
