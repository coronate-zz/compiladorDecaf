...
class CodeGenerator {
  ...
  public:
    ...
    Hashtable<Node*>* globalSymbolTable;

    CodeGenerator();
    
    // getters and setters for frameSize
    void resetFrameSize() { frameSize = 0; }
    void addVarToFrameSize() { frameSize += VarSize; }
    int getFrameSize() { return frameSize; }

    void addVarToGlobalSize() { globalSize += VarSize; }
